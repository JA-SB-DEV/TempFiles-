                   ...
                   <div className={`w-full mx-4 h-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-8 rounded-xl font-mono ${theme.color} whitespace-pre-wrap overflow-auto max-h-[60vh] shadow-inner text-sm relative leading-relaxed`}>
                    ...
                    <div className="w-full h-full p-4 flex flex-col items-center justify-center gap-6">
                        {foundFile.mimeType === 'application/pdf' ? (
                            ...
                            <div className={`text-center p-8 rounded-2xl border flex flex-col items-center bg-emerald-500/10 dark:bg-emerald-900/10 border-emerald-500/20`}>
                                <FileIcon size={64} className="text-emerald-500 mx-auto mb-4" />
                                <p className={`font-bold mb-2 text-emerald-600 dark:text-emerald-400`}>
                                    Documento Descifrado
                                </p>
                                <p className={`text-xs font-mono uppercase mb-4 opacity-60 text-emerald-600 dark:text-emerald-400`}>
                                    {foundFile.mimeType}
                                </p>
                            </div>
                        )}
                        <a 
                            ...
                            className={`px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg transition-all hover:scale-105 text-white bg-emerald-500 hover:bg-emerald-600`}
                        >
